...
class Quan_Ly_Du_Lieu:
    ...
    # Hàm kiểm tra tồn tại,hàm chỉ truy vấn SELECT (đọc dữ liệu), không làm thay đổi database nên không cần commit()
    ...
    # Hàm tìm kiếm đơn hàng theo ký tự nhập vào, hàm chỉ truy vấn SELECT (đọc dữ liệu), không làm thay đổi database nên không cần commit()
